...
int main(int argc, char **argv) {
    ...
    while(signature_algorithms[algorithm_count] > 0) {
        ...
        RESULT(("cert sign: algorithm %d, signature length (%d) is not negative", signature_algorithms[algorithm_count], signature_len), signature_len > -1);
        ...
        RESULT(("fp sign:   algorithm %d, signature length (%d) is not negative", signature_algorithms[algorithm_count], signature_len), signature_len > -1);
